...
const WhatsNew = () => {
    ...
    return ( 
        <Box id="home-hero" minHeight="80vh" sx={whatsnewHeroStyles} display="flex">
            <Container as="section" maxWidth={{ xl: "1140px"}}>
                <Heading as="h1" fontSize="40px" fontWeight="600" align="center">WHAT'S NEW</Heading>
